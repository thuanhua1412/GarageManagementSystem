...
// TODO: Add the method to onSnapShot to check for changes on firebase
//  --> Update the data accrodingly (Example: Garage App Denial of Some Services)
//  --- Thinh on 5th, April - 2021

class ServiceCartViewModel(): ViewModel(){
