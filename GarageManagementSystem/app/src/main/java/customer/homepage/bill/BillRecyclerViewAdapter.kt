...
class BillRecyclerViewAdapter(private val serviceList: List<Service>, private val listener:ServiceItemClickListener): RecyclerView.Adapter<BillRecyclerViewAdapter.ServiceItemViewHolder>(){
    ...
    inner class ServiceItemViewHolder(ServiceItemView: View): RecyclerView.ViewHolder(ServiceItemView),
